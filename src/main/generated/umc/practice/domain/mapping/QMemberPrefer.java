...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    private static final long serialVersionUID = 1113033348L;
    ...
    public final umc.practice.domain.QFoodCategory foodCategory;

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final umc.practice.domain.QMember member;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new umc.practice.domain.QFoodCategory(forProperty("foodCategory")) : null;
        this.member = inits.isInitialized("member") ? new umc.practice.domain.QMember(forProperty("member")) : null;
    }

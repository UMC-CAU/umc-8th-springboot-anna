...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1532409752L;
    ...
    public final EnumPath<umc.practice.domain.enums.MissionStatus> status = createEnum("status", umc.practice.domain.enums.MissionStatus.class);
